...
class AdapterModulTerbaru2
    (private val context: Context,internal var id_user: String,internal var nama: String ,internal var telepon: String,
     ...
     internal var created_at: String , internal var position: String , internal var about: String ,private val results: List<Result>) : RecyclerView.Adapter<AdapterModulTerbaru2.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: AdapterModulTerbaru2.ViewHolder, position: Int) {
