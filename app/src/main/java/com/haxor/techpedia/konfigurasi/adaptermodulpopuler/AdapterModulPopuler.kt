package com.haxor.techpedia.konfigurasi.adaptermodulpopuler
...
class AdapterModulPopuler(private val context: Context, private val results: List<Result>) : RecyclerView.Adapter<AdapterModulPopuler.ViewHolder>() {
